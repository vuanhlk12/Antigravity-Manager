  ...
  const handleSelectAntigravityIdePath = async () => {
    try {
      const selected = await open({
        ...
        multiple: false,
        title: t(
          "settings.advanced.antigravity_ide_path_select",
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          refresh_interval: isNaN(parseInt(e.target.value))
                            ? 1
                            : Math.min(
                  ...
                  <div className="mt-5 pt-5 border-t border-gray-50 dark:border-base-300 flex items-center gap-4 animate-in slide-in-from-top-1 duration-200">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          sync_interval: isNaN(parseInt(e.target.value))
                            ? 1
                            : Math.min(
                                Math.max(parseInt(e.target.value), 1),
                                35791,
            ...
            <>
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-900 dark:text-base-content mb-1">
                    {t(
                      "settings.advanced.antigravity_ide_path",
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder={t(
                        "settings.advanced.antigravity_ide_path_placeholder",
                        "D:\\Antigravity\\Antigravity.exe",
                      )}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          antigravity_ide_executable: e.target.value,
                        })
                      }
                    />
                    {formData.antigravity_ide_executable && (
                      <button
                        ...
                        onClick={() =>
                          setFormData({
                            ...formData,
                            antigravity_ide_executable: undefined,
                          })
                        }
                      >
                        {t("common.clear")}
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                    {t(
                      "settings.advanced.antigravity_ide_path_desc",
                      "Specify the executable path for Antigravity IDE (code editor). Once set, account switching will strictly protect processes at this path from being terminated.",
                    )}
                  </p>
                </div>
